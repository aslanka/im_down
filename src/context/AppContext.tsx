...
import { Activity, ActivityCategory, AppNotification, FriendGroup } from '@/src/types';
...
const ACTIVITY_STORAGE_KEY = 'imdown.activities.v2';
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    ]).then(([savedActivities, savedFriends, savedGroups]) => {
  ...
  }), [activities, notifications, friendIds, groups]);
